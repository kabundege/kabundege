...
const Work = () => {
    ...
    return (
        <div id="work" className="flex justify-between">
            <section className="w-1/3 bg-gray-600 relative">
            ...
            <section className="w-5/12 grid grid-cols-1 border-2 border-gray-100 overflow-scroll">
                {
                    React.Children.toArray(
                        data.map((one,index) => 
                            <div className={` w-1/2 ${ index%2 ? "" :'ml-auto'}`} style={{ marginTop: index ? '-4.5em' : '4em' }} >
